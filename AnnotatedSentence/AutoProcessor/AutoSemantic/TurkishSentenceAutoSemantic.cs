...
namespace AnnotatedSentence.AutoProcessor.AutoSemantic
{
    public class TurkishSentenceAutoSemantic : SentenceAutoSemantic
    {
         ...
         */
        protected override void AutoLabelSingleSemantics(AnnotatedSentence sentence)
        {
            ...
            for (var i = 0; i < sentence.WordCount(); i++)
            {
                ...
                {
                    if (previous != null && twoPrevious != null && twoPrevious.GetParse() != null && previous.GetParse() != null)
                    {
